...
public class FinalPracticsEJB {
  ...
  public List<FinalPractic> fetchAll() {
    TypedQuery<FinalPractic> q = em.createQuery(
            "SELECT fp FROM FinalPractic fp ORDER BY fp.plan, fp.number, fp.name", FinalPractic.class);
    return q.getResultList();
  }
  
  public List<FinalPractic> findByPlan(final StudyPlan plan) {
    TypedQuery<FinalPractic> q = em.createQuery(
